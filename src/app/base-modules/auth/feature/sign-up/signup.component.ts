...
export class SignupComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    this.userForm = this.formBuilder.group({
      ...
      phone: ['', [Validators.required, Validators.maxLength(12), Validators.pattern(this.myPattern.fixedPhone)]], //شماره تلفن ثابت
      mobile: ['', [Validators.required, Validators.maxLength(11), Validators.pattern(this.myPattern.phone)]], // شماره همراه
      address: ['', [Validators.required, Validators.pattern(this.myPattern.faAndEnNumberAndTextParagraph)]], //آدرس
      organizationalUnit: ['', [Validators.required, Validators.pattern(this.myPattern.faAndEnNumberAndTextParagraph)]], //واحد سازمانی
      organizationalLevel: ['', [Validators.required, Validators.pattern(this.myPattern.faAndEnNumberAndTextParagraph)]],
      city: ['', [Validators.required, Validators.pattern(this.myPattern.faAndEnNumberAndTextParagraph)]],// شهر
      province: ['', [Validators.required, Validators.pattern(this.myPattern.faAndEnNumberAndTextParagraph)]],//استان
